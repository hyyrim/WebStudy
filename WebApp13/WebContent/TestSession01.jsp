...
<%
   ...
   // session 의 userId 에 superman(=자신이 쓴 id) 을 담아서 보낸 상황
   
   String userId = (String)session.getAttribute("userId");
   //-- session.getAttribute("userId") 는 
   //    Object 타입을 반환하므로
   //    String 타입으로 변환하는 과정 필요 (다운캐스팅)
   //    key값만 명시해주면 value를 얻게 된다
   ...
   //-- 세션이 유지되는 시간을 30초로 변경하여 설정한 상태
   //	로그인 후 30초 뒤 새로고침 하면 로그아웃 처리
...
<script type="text/javascript">
   ...
   function sendIt()
   {
      ...
      // form.안에 있는 userId (name=userId)의 값이 비어있으면
...
<div>
   <table class="table">   
      <tr>
         <td>
            <a href=""><button type="button" class="btn01"
         ...
         <td>
            ...
            {
            %>
            <a href=""><button type="button" class="btn02"
            ...
            {
            %>
            <a href="TestSession02.jsp"><button type="button" class="btn01"
            style="width:80px; font-size:5pt;">일정관리</button></a>|
            <%
            }
            %>
         ...
         <td>
            ...
            {
            %>
            <a href="TestSession03.jsp"><button type="button" class="btn01"
            style="width:80px; font-size:5pt;">친구관리</button></a>|
            <%
            }
            %>
