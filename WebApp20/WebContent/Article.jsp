...
<%
   // 테스트
   /*
   String pageNum = request.getParameter("pageNum"); -- 글 목록으로 돌아갈시 페이지 번호 기억해야함 
   ...
   */
   ...
   if(dto==null) // 글을 클릭하니까 작성자가 삭제한 경우.. 목록으로 돌려보낸다
      response.sendRedirect("List.jsp");
   
   // 게시물 본문의 라인 수 확인 및 게시물 내용 재구성
   int lineSu = dto.getContent().split("\n").length;
   // split 이 반환하는건 배열 여기에 .length 하면 배열방의 길이가 나옴
